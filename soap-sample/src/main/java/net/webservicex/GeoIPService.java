 ...
 * 2017-03-06T22:49:56.896+03:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "GeoIPService", 
                  wsdlLocation = "file:src/main/resources/geoipservice.asmx.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/geoipservice.asmx.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/geoipservice.asmx.wsdl");
        }
        WSDL_LOCATION = url;
    }
